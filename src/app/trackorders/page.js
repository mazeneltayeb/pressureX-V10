    ...
    <Container className="py-4">
        ...
        <Col md={4} className="text-end">
          <div className="d-flex gap-2 justify-content-end">
            <Button 
              ...
              style={{color:'black', border:"0" , fontWeight:"bold"}}
            >
      ...
      {customerOrders.length > 0 ? (
        <>
          ...
          {/* Orders Table */}
          <Card className="shadow-sm">
            <Card.Header className="bg-light text-center main-color">
              <h5 className="mb-0">📋 جميع طلباتك</h5>
            </Card.Header>
            <Card.Body className="p-0">
              <div className="table-responsive">
                <Table hover className="mb-0">
                  <thead className="table-light">
                    <tr>
                      <th className="d-none d-sm-none d-md-table-cell">رقم الطلب</th>
                      <th className="d-none d-sm-none d-md-table-cell">التاريخ</th>
                      <th>المنتجات</th>
                      <th>المبلغ</th>
                      <th>الحالة</th>
                      <th>الإجراءات</th>
                  ...
                  <tbody>
                    {customerOrders.map((order) => (
                      <tr key={order.id}>
                        ...
                        <td className="d-none d-sm-none d-md-table-cell">{formatDate(order.created_at)}</td>
                        <td>
                          {(() => {
                            try {
                              if (!order.items) return <span className="text-muted">لا توجد تفاصيل</span>;
